...
from cycle_rigidity_boundary_certificate import cycle_rigidity_boundary_certificate
...
def main() -> int:
    doc = ROOT / "docs/status/CYCLE_RIGIDITY_BOUNDARY_CERTIFICATE.md"
    source = ROOT / "src/cycle_rigidity_boundary_certificate.py"
    status = ROOT / "STATUS.md"
    if not status.exists():
        status = ROOT / "README.md"
    require(doc.exists(), "missing cycle rigidity boundary certificate doc")
